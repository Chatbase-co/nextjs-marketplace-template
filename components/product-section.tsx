    ...
    <section className="relative py-10">
      <div className="mx-auto max-w-4xl px-6 text-center lg:px-8">
        <div className="inline-block">
          <div className="font-serif text-5xl leading-tight tracking-tight text-foreground lg:text-6xl flex items-center gap-4">
            <span className="text-balance">
              Cut response time in
            </span>
        ...
        <p className="mt-8 text-lg leading-relaxed text-muted-foreground lg:text-xl">
          Automated routing, unified channels, and real-time analytics that help teams resolve tickets 2x faster.
        </p>
        ...
        <div className="mt-16 grid gap-5 text-left md:grid-cols-3">
          <div className="group relative rounded-2xl border border-accent/20 bg-gradient-to-b from-accent/5 to-transparent p-5 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:border-accent/40 hover:shadow-xl">
            ...
            <h3 className="font-serif text-xl text-foreground">40% faster resolution</h3>
            <p className="mt-4 leading-relaxed text-muted-foreground">
              AI routing assigns tickets to the right agent based on expertise and workload.
            </p>
          </div>
          <div className="group relative rounded-2xl border border-accent/20 bg-gradient-to-b from-accent/5 to-transparent p-5 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:border-accent/40 hover:shadow-xl">
            ...
            <p className="mt-4 leading-relaxed text-muted-foreground">
              Handle email, chat, and social media tickets from a single dashboard.
            </p>
          </div>
          <div className="group relative rounded-2xl border border-accent/20 bg-gradient-to-b from-accent/5 to-transparent p-5 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:border-accent/40 hover:shadow-xl">
            ...
            <p className="mt-4 leading-relaxed text-muted-foreground">
              Track resolution times, agent performance, and customer satisfaction in real-time.
            </p>
          </div>
        </div>
      </div>
